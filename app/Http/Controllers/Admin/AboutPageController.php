...
class AboutPageController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        $request->validate([
            ...
            'intro_paragraph_1' => ['required', 'string', 'max:5000'],
            'intro_paragraph_2' => ['nullable', 'string', 'max:5000'],
            ...
            'fleet_subsections.*.body' => ['nullable', 'string', 'max:2000'],
            ...
            'sustainability_items.*.description' => ['nullable', 'string', 'max:500'],
