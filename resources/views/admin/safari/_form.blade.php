...
<div class="space-y-8">
    ...
    <div class="rounded-2xl border border-secondary/50 bg-white p-6 shadow-soft sm:p-8">
        ...
        <div x-data="fileImagePreview(@js($previewUrl ?: null))" class="mt-4">
            <input
                type="file"
                name="image"
            ...
            <button
                type="button"
                class="flex w-full cursor-pointer flex-col items-center rounded-xl border-2 border-dashed border-secondary/55 bg-secondary/10 px-4 py-8 text-center transition hover:border-primary/35 hover:bg-primary/[0.04] sm:flex-row sm:justify-center sm:gap-4 sm:py-6"
                @click="openPicker()"
            >
            ...
            <div x-ref="previewPanel" x-show="hasPreview" x-cloak class="mt-4 overflow-hidden rounded-xl border border-secondary/45 bg-white shadow-sm">
