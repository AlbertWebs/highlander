    ...
    <div class="site-gutter-x relative z-10 w-full">
        ...
        <div class="w-full pb-2">
            ...
            @if(filled($setting->hero_subtitle))
                <div
                    class="about-rich-text about-rich-text--hero mt-8 hidden w-full max-w-none text-xl font-medium leading-relaxed text-white sm:mt-10 sm:block sm:text-2xl sm:leading-snug lg:mt-12 [text-shadow:0_1px_3px_rgba(0,0,0,0.75),0_4px_28px_rgba(0,0,0,0.55)]"
                    data-aos="fade-up"
