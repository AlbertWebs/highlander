...
@php
    $heading = $title ?? __('Articles');
    $bg = 'https://images.unsplash.com/photo-1516426122078-c23e763b01e0?auto=format&fit=crop&w=2400&q=80';
    $overlay = "linear-gradient(to top, rgba(10,12,12,.82), rgba(10,12,12,.38)), url('{$bg}')";
@endphp
<section class="relative flex min-h-[38vh] max-h-[48vh] items-end overflow-hidden pt-28 pb-14 sm:min-h-[42vh]" aria-labelledby="articles-hero-heading">
    ...
    <div class="site-gutter-x relative z-10 w-full">
        <nav class="mb-5 text-sm text-white/75" aria-label="{{ __('Breadcrumb') }}">
            <ol class="flex flex-wrap items-center gap-2">
                ...
                <li class="font-medium text-white">{{ __('Articles') }}</li>
            </ol>
        </nav>
        <h1 id="articles-hero-heading" class="inline-block font-serif text-4xl font-semibold tracking-tight text-white sm:text-5xl" data-aos="fade-up" data-aos-duration="850">
