...
<div class="space-y-6 lg:sticky lg:top-24 lg:z-10 xl:top-28">
    @if($tour->duration_days)
        <div class="overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/[0.07] via-white to-tint-green/30 shadow-[0_8px_32px_rgba(46,46,46,0.07)] ring-1 ring-primary/10" aria-labelledby="experience-glance-heading">
            <div class="border-b border-primary/10 bg-primary/[0.05] px-5 py-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-xs text-ink/55">{{ __('Typical pace on the ground') }}</p>
                    </div>
                </div>
            </div>
            <div class="px-5 py-5">
                ...
                <p class="mt-4 border-t border-secondary/30 pt-4 text-sm leading-relaxed text-ink/65">
                    {{ __('Exact routing and camp choices depend on season; we confirm details when you enquire.') }}
                </p>
            </div>
        </div>
    @endif
