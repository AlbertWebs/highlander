...
<div class="space-y-6 lg:sticky lg:top-24 lg:z-10 xl:top-28">
    ...
    <div class="overflow-hidden rounded-3xl border border-secondary/30 bg-white/95 shadow-[0_4px_28px_rgba(46,46,46,0.06)] ring-1 ring-black/[0.03]" aria-labelledby="mountains-sidebar-tours-heading">
        <div class="border-b border-secondary/30 bg-gradient-to-r from-primary/[0.06] to-transparent px-4 py-3.5 sm:px-5">
            <div class="flex items-center gap-2">
                ...
                <div>
                    <h2 id="mountains-sidebar-tours-heading" class="text-[0.65rem] font-semibold uppercase tracking-[0.2em] text-primary">{{ __('Mountain itineraries') }}</h2>
                    <p class="text-xs text-ink/50">{{ __('Trekking & peak routes listed under Mountain safari') }}</p>
                </div>
            </div>
        </div>
            ...
            @forelse($featuredTours as $tour)
                ...
                >
                    <div class="relative h-[4.75rem] w-[5.75rem] shrink-0 overflow-hidden rounded-xl bg-secondary/35 ring-1 ring-secondary/40 shadow-sm">
                        ...
                        @endif
                        @if($tour->is_featured)
                            <span class="absolute left-1 top-1 rounded-md bg-primary/95 px-1.5 py-0.5 text-[0.58rem] font-bold uppercase tracking-wide text-white shadow-sm">{{ __('Featured') }}</span>
                        @endif
                    </div>
